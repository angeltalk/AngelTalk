...
import static act.angelman.presentation.util.ResourceMapper.ColorType.PURPLE;
...
import static act.angelman.presentation.util.ResourceMapper.IconType.TSHIRT;
...
public class CategoryDataSqliteDataStoreTest {
    ...
    private String SQL_CREATE_CATEGORY_LIST =
            "CREATE TABLE " + act.angelman.data.sqlite.CategoryColumns.TABLE_NAME + "(" +
                    act.angelman.data.sqlite.CategoryColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," +
                    act.angelman.data.sqlite.CategoryColumns.TITLE + " TEXT," +
                    act.angelman.data.sqlite.CategoryColumns.ICON + " INTEGER," +
                    act.angelman.data.sqlite.CategoryColumns.COLOR + " INTEGER," +
                    act.angelman.data.sqlite.CategoryColumns.INDEX + " INTEGER)";
