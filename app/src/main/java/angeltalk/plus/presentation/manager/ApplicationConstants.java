...
public class ApplicationConstants {
    ...
    public static final String PRIVATE_PREFERENCE_NAME = "angeltalk.plus";
    ...
    public static final int ONBOARDING_PERMISSION_REQUEST_CODE = 1;
    ...
    public static final int RECORDING_PERMISSION_REQUEST_CODE = 5;
