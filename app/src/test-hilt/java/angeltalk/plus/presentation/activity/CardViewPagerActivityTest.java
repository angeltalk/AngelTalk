...
public class CardViewPagerActivityTest extends UITest {
    ...
    @BindValue
    CardTransfer cardTransfer = Mockito.mock(CardTransfer.class);

    @BindValue
    MessageTransfer messageTransfer = Mockito.mock(MessageTransfer.class);
    ...
    public void whenLaunchedCardViewPager_thenShowsAddNewCardPageOnViewPager() throws Exception {
        ...
        assertThat(subject.buttonContainer.getVisibility()).isEqualTo(View.GONE);

        assertThat(subject.cardTitleLayout.listCardButton.getVisibility()).isEqualTo(View.VISIBLE);
    ...
    public void givenLaunched_whenMoveToPhotoCard_thenShowTitleCorrectly() throws Exception {
        ...
        assertThat(view.findViewById(R.id.card_video).getVisibility()).isEqualTo(View.GONE);
        assertThat(view.findViewById(R.id.card_image).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.buttonContainer.getVisibility()).isEqualTo(View.VISIBLE);
    }
    ...
    public void givenLaunched_whenMoveToVideoCard_thenShowTitleCorrectly() throws Exception {
        ...
        assertThat(view.findViewById(R.id.card_video).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(view.findViewById(R.id.card_image).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(view.findViewById(R.id.play_button).getVisibility()).isEqualTo(View.INVISIBLE);
        assertThat(subject.buttonContainer.getVisibility()).isEqualTo(View.VISIBLE);
    }
    ...
    public void givenShownVideoCardOnScreen_whenClickCardView_thenPlayVideo() throws Exception {
        ...
        assertThat(((VideoCardTextureView) cardView.findViewById(R.id.card_video)).getVisibility()).isEqualTo(View.VISIBLE);
    }
