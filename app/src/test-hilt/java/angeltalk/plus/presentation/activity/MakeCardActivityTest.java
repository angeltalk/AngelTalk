...
import angeltalk.plus.presentation.shadow.ShadowViewTreeObserver;
...
import static angeltalk.plus.R.id.counting_scene;
...
public class MakeCardActivityTest extends UITest{
    ...
    @Test
    public void whenCompletedCardTitleTyping_thenShowMicButtonAndGuideText() throws Exception {
        setupPhotoCard();
        ...
        assertThat(subject.findViewById(R.id.mic_btn).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.findViewById(R.id.recoding_guide).getVisibility()).isEqualTo(View.VISIBLE);
    }
    ...
    public void givenEditCardForRenaming_whenLaunched_thenShowDisabledConfirmButton() throws Exception {
        ...
        assertThat(subject.confirmButton.isEnabled()).isFalse();
    ...
    public void givenEditCardForRenaming_whenCompleteEditing_thenShowEnabledConfirmButton() throws Exception {
        ...
        // then
        assertThat(subject.confirmButton.getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.confirmButton.isEnabled()).isTrue();
        ShadowDrawable shadowDrawable = shadowOf(subject.confirmButton.getBackground());
    ...
    public void whenFinishCountDown3To1_thenHideSkipButtonAndStartVoiceRecordAndShowsCheckRecordAndRetakeAndReplayButtonsAndText() throws Exception {
        ...
        assertThat(recordStopBtn.getVisibility()).isEqualTo(View.VISIBLE);
    ...
    public void givenVoiceRecordFinished_whenClickReplayButton_thenStartVoicePlay() throws Exception {
        ...
        assertThat(replayButton.getVisibility()).isEqualTo(View.VISIBLE);
    ...
    public void whenStopRecordAndCheckButtonIsClicked_thenCreateNewCard() throws Exception {
        ...
        recordComplete();
        subject.findViewById(R.id.record_stop_button).performClick();
        verify(cardRepository).createSingleCardModel((CardModel) any());
    }
    ...
    public void givenCardTitleShownMode_whenClickedHardwareBackButton_thenChangeCardStatusAndShowKeyBoard() throws Exception {
        ...
        assertThat(cardTitleEdit.getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(cardTitle.getVisibility()).isEqualTo(View.GONE);
    ...
    public void whenShowMakeVideoCardActivity_thenShowVideoPreviewAndPlayButton() throws Exception {
        setupVideoCard();
        assertThat(subject.findViewById(R.id.card_image).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.findViewById(R.id.card_video).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.findViewById(R.id.play_button).getVisibility()).isEqualTo(View.VISIBLE);
    }
    ...
    public void whenShowMakePhotoCardActivity_thenShowImageView() throws Exception {
        setupPhotoCard();
        assertThat(subject.findViewById(R.id.card_image).getVisibility()).isEqualTo(View.VISIBLE);
        assertThat(subject.findViewById(R.id.card_video).getVisibility()).isEqualTo(View.GONE);
        assertThat(subject.findViewById(R.id.play_button).getVisibility()).isEqualTo(View.GONE);
    }
